...
public class ScreenshotTask81 {
    ...
    public void PurchaseProduct() throws Exception {
        ...
        driver.findElement(By.id("loginusername")).sendKeys("Janasi13");
        driver.findElement(By.id("loginpassword")).sendKeys("Janasi@123");
        ...
        driver.findElement(By.id("name")).sendKeys("Janasi");
